...
def _safe_latest(arr: np.ndarray) -> float | None:
...
def agent_fundamentals_analyst(state: StockResearchState) -> dict:
    ...
    return {"fundamentals_report": response.content.strip()}
...
def agent_sentiment_scanner(state: StockResearchState) -> dict:
    ...
    return {"sentiment_report": response.content.strip()}
...
def agent_technical_analyst(state: StockResearchState) -> dict:
    ...
    return {"technical_report": response.content.strip()}
...
def agent_brief_writer(state: StockResearchState) -> dict:
    ...
    return {"investment_brief": response.content.strip()}
